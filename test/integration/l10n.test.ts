 ...
 */
describe('Paths-LE localization', function () {
	this.timeout(30_000);

	const extension = vscode.extensions.getExtension('nolindnaidoo.paths-le');
	...
	it('substitutes positional placeholders at runtime', () => {
		...
		const one = vscode.l10n.t('Extracted {0} paths from document', 7);
